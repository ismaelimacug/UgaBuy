        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              ...
              <a href="https://tiktok.com/.ugabuy" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-primary transition-colors" data-testid="social-tiktok">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
